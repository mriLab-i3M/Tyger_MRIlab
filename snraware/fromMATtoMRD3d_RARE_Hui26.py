"""
Hui Xue
Convert i3m mat data to MRD format. 

Information about mat data structure can be found in the MaRGE wiki:
https://github.com/josalggui/MaRGE/wiki/Raw-Data-structure
"""
