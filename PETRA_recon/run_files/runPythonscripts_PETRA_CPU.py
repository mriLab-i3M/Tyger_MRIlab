...
rawData = "/home/teresa/Documentos/Papers/Tyger/experiments/PETRA/PETRA.2025.10.27.22.15.15.662.mat"
out_field = "img_cpu"
runTyger = 1
...
if runTyger == 1:
    ...
    yml_path = "PETRA_recon/yml_files/python_petra_example.yml"
    ...
    p2 = subprocess.Popen(
        ["python3", "PETRA_recon/recon_scripts/stream_recon_PETRA_CPU.py"]+args,
        stdin=p1.stdout,
        stdout=subprocess.PIPE
    )
