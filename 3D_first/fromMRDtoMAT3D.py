...
def export(input, output):
    ...
    rawData['imgReconTyger3D_20.01.25'] = imgRecon
...
if __name__ == "__main__":
    ...
    # parser.set_defaults(
    #     input = '/home/teresa/marcos_tyger/Tyger_MRIlab/3D/testResult.bin',
    #     output= '/home/teresa/marcos_tyger/Tyger_MRIlab/3D/knee.mat',
    # )
