...
spdsMap = "/home/tyger/tyger_repo_may/spdsppTest/SPDS.2025.07.11.21.46.06.918.mat"
...
start1 = time.time()
p1 = subprocess.Popen(
    ["python3", "RARE_recon/recon_scripts/fromMATtoMRD3D_RARE_SPDSpp.py", "-i", rawData, "-spds", spdsMap],
    stdout=subprocess.PIPE,
)

# Paso 2: Código python que ejecutaré desde Tyger
yml_path = "RARE_recon/yml_files/python_next1_july_newBranch.yml"
...
p2 = subprocess.Popen(
    ["python3", "RARE_recon/recon_scripts/stream_recon_RARE_spdsPP.py"]+args,
    stdin=p1.stdout,
    stdout=subprocess.PIPE
)
...
plt.tight_layout()
plt.savefig('RARE_recon/compTygerPP.png', bbox_inches='tight', dpi=300)
# plt.show()
